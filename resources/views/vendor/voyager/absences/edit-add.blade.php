                                    ...
                                    <div class="form-group  " style="margin-left: 15px;">
                                      <div class="row">
                                        ...
                                        <div class="col-sm-2">
                                          ...
                                          <input type="number" name="Permission" class="form-control" placeholder="Permission" value="@if(isset($dataTypeContent->Permission)){{$dataTypeContent->Permission}}@endif">
                                        </div>
                                        <div class="col-sm-2" >
                                          <label for="name">Non-Permission</label>
                                          <input type="number" name="Non_permission" class="form-control" placeholder="Non Permission" value="@if(isset($dataTypeContent->Non_permission)){{$dataTypeContent->Non_permission}}@endif">
                                        </div>
