                                    ...
                                    <div class="form-group  " style="margin-left: 15px;">
                                      <div class="row">
                                        ...
                                        <div class="col-sm-2" style="float:right;">
                                          ...
                                          <input type="number" name="Total" min="1" max="10" step=".01" class="form-control" placeholder="Total" value="@if(isset($dataTypeContent->Total)){{$dataTypeContent->Total}}@endif">
                                        </div>
